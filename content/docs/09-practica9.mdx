...
- **Notebook:** [Práctica 9 - Encoding Avanzado y Target Encoding](https://example.com)
...
![Cardinalidad de variables categóricas](/practico%209/cardinalidad_variables_cat.png)
...
![Experimento de smoothing para Target Encoding](/practico%209/smoothing_experiment.png)
...
![Top features más importantes del pipeline branched](/practico%209/Top_Features_mas_importantes.png)

![Análisis de features codificadas](/practico%209/analisis_de_features_codificadas.png)

![Comparación de importancia por método](/practico%209/comparacion_importancia_por_metodo.png)
...
![Comparación visual de métodos de encoding](/practico%209/comparacion_metodos_de_encoding.png)
